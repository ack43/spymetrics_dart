...
class _TotalTrafficApi implements TotalTrafficApi {
  _TotalTrafficApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<VisitsSplitResponse> visitsSplit(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late VisitsSplitResponse _value;
    try {
      _value = VisitsSplitResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<Map<String, Object>> describe(
    ...
    final _options = _setStreamType<Map<String, Object>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/website/${domain}/total-traffic-and-engagement/describe',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
