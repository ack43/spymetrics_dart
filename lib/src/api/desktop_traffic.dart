...
abstract class DesktopTrafficApi {
  ...
  // GET Desktop Pages / Visit [View Demo]
  ...
  // GET Desktop Avg. Visit Duration [View Demo]
  ...
  // GET Geography Distribution [View Demo]
  ...
  // GET Desktop Unique Visitors [View Demo]
